...
export const LoginPage = () => {
  ...
  const handleSocialLogin = (provider: 'google' | 'github' | 'twitter') => {
    ...
    setError(`Login com ${provider} em desenvolvimento`);
  };
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-100 dark:border-blue-800">
          ...
          <div className="space-y-1 text-sm text-blue-700 dark:text-blue-400">
            <p><span className="font-semibold">Email:</span> demo@askme.com</p>
            <p><span className="font-semibold">Senha:</span> demo123</p>
          </div>
          <p className="mt-2 text-xs text-blue-600 dark:text-blue-500">
            Use estas credenciais para testar o login rapidamente.
          </p>
        </div>
      </div>
    </div>
